...
namespace MLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\SourceCodes\ml\MLApp\MLApp\InputData\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../MLAppML.Model/MLModel.zip";
